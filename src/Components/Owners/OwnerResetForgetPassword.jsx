...
import Styles from "./OwnerResetForgetPassword.module.css";
import 'remixicon/fonts/remixicon.css'
import { useNavigate, useParams } from "react-router-dom";

const OwnerResetForgetPassword = () => {
  ...
  const handleResetPassword = async () => {
    ...
    try {
        const response = await axios.post(`/owner/forget-link/${id}`, { otp: otp, password: password });
...
export default OwnerResetForgetPassword